    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 offset-md-1">
                ...
                <form id="edit-movie-form" action="<?= $BASE_URL ?>movie-process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="length" name="length" placeholder="Digite a duração do filme" value="<?= $movie->duration ?>">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="movie-image-container" style="background-image: url('<?= $BASE_URL ?>img/movies/<?= $movie->img ?>')"></div>
            </div>
        </div>
    </div>
</div>
